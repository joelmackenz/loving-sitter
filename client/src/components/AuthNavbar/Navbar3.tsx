...
// export const NotificationPopper: React.FC<NotificationProps> = ({ titleAnchor, activeNotifications }) => {
...
//     setMobilePopperAnchor(null);
//     console.log(target, profilePopperAnchor);
...
//     >
//       <MenuList autoFocusItem={Boolean(profilePopperAnchor)} onClick={() => setMobilePopperAnchor(null)}>
//         <MenuItem>
...
//       <IconButton onClick={(e) => setMobilePopperAnchor(e.currentTarget)}>
//         <MoreHorizIcon />
//       </IconButton>
//       <IconButton onClick={(e) => handleToggleProfilePopper(e.currentTarget)}>
//         <Avatar src={profileImage} className={classes.avatar} />
