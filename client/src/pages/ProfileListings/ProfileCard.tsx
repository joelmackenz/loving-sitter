...
import { specificImage } from './dummyProfilePhotos';
        ...
        <CardActionArea>
          <CardContent className={classes.cardContentUpper}>
            <Avatar
              ...
              src={
                typeof parseInt(profile.profileId[0].profileImg) === 'number'
                  ? specificImage(parseInt(profile.profileId[0].profileImg))
